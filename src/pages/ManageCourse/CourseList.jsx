                    ...
                    <tbody>
                        {courses?.map((course, index) => (
                            <tr key={course._id}>
                                ...
                                <td>
                                   <Link to={`/update-course/${course._id}`}> <button className="btn btn-outline btn-info">Edit</button></Link>
                                </td>
                                <td>
                                    <button onClick={() => handleDelete(course._id)} className="btn btn-outline btn-error">Delete</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
